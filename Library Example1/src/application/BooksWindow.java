...
public class BooksWindow {
    ...
    static private TableView<Stock> table;
    static private ConnectionClass conn;
    static private TableColumn<Stock, String> title;
    static private TableColumn<Stock, String> author;
    static private TableColumn<Stock, String> category;
    static private TableColumn<Stock, String> shelfID;
    static private TableColumn<Stock, Integer> available;
    ...
    static{
        ...
        category = new TableColumn<>("Category/Release Date");
        ...
        try {
            table = new TableView<Stock>(conn.getAllBooks("All"));
        ...
        table.setRowFactory(tab -> new TableRow<Stock>() {
            @Override
