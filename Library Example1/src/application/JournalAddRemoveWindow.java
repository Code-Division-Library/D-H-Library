...
public class JournalAddRemoveWindow {

	static private VBox centerVBox;
    static Connection myCon;
    static TableView<Journal> table;
    static ConnectionClass conn;
    static private TableColumn<Journal, String> title;
    static private TableColumn<Journal, Integer> volume;
    static private TableColumn<Book, String> actedBy;
    static private TableColumn<Journal, Date> date;
    static private TableColumn<Journal, String> releaseDate;
    static private TableColumn<Journal, String> country;
    static private TableColumn<Journal, Integer> actedByVolume;
    static private TableColumn<Journal, String> actedByName;
    static private TableColumn<Journal, Integer> copies;
    ...
    static{
        ...
        releaseDate = new TableColumn<>("Release Date");
        releaseDate.setPrefWidth(230);
        ...
        actedByVolume = new TableColumn<>("Volume");
        actedByName = new TableColumn<>("Name");
        actedByVolume.setPrefWidth(115);
        actedByName.setPrefWidth(115);
        actedByVolume.setCellValueFactory(new PropertyValueFactory<>("addedByVolume"));
        ...
        searchOption.getItems().addAll("Title", "Volume","Release Date");
        ...
        searchOption.setOnAction(event -> {
            switch(searchOption.getValue()){
                case "Title":
                    searchBox.setPromptText("search by Journal Title");
                    break;
                case "Volume":
                    searchBox.setPromptText("search by Journal Author");
                    break;
                case "Release Date":
                    searchBox.setPromptText("search by Journal Release Date");
                    break;
            }
        });
        ...
        table = new TableView<Journal>();
        table.getColumns().addAll(title, volume,date,releaseDate, country,copies);
    ...
    public static  VBox getAddRemJournalWindow() {
        refresh();
        return centerVBox;
    }
