...
public class AdminWindow {
    ...
    public AdminWindow(int id,String firstName,String lastName,String email, String password, int phoneNumber, String abilityLevel){
        ID=id;
    ...
    public void start(Stage arg,Scene prevSc) throws SQLException {
        ...
        Label lbl = new Label("Duffy&Henderson Library");
        ...
        Button addRemJournals = new Button("Add/Remove Journals");
        addRemJournals.getStyleClass().add("btn");
        addRemJournals.setStyle("-fx-font-size:16");
        addRemJournals.setMaxSize(300, 40);
        addRemJournals.setPrefSize(300, 0);
        addRemJournals.setMinSize(300, 0);
        ...
        history.setOnAction(event -> {
            ...
            animate.setButtonAnimation(issuedBooks,addRemBooks); 
        ...
        action.setOnAction(event -> {
            ...
            animate.setButtonAnimation(issueBook,receiveBooks,add, remove); 
           Thread thread=new Thread(animate);
            thread.start();
        });
        ...
        Button book= new Button("Books and Journals");
        ...
        switch (abilityLevel) {
            ...
            case "Employee":
                ...
                left.getChildren().addAll(dashboard,  history, issuedBooks, addRemBooks,addRemJournals,  action, issueBook, receiveBooks, add, remove); //finance, financeActivity
        ...
        addRemBooks.setOnAction(event -> {
            cBox.setValue(name);
            bor.setCenter(BookAddRemoveWindow.getAddRemBookWindow());
        });
        addRemJournals.setOnAction(event -> {
            cBox.setValue(name);
            bor.setCenter(JournalAddRemoveWindow.getAddRemJournalWindow());
        });
        ...
        add.setOnAction(event -> {
            ...
            addJournal.setMinSize(200,200);
            addJournal.setPrefSize(200,200);
            addJournal.setMaxSize(200,200);
            HBox halfAdd= new HBox();

            halfAdd.getChildren().addAll(addMember,addBook,addJournal);
            ...
            addJournal.setOnAction(event1 -> {
                Registration reg= Registration.getInstance();
                reg.addJournals(ID,password);
        ...
        remove.setOnAction(event -> {
            ...
            Button remJournal =new Button("Remove Journal");
            ...
            remJournal.setMinSize(200,200);
            remJournal.setPrefSize(200,200);
            remJournal.setMaxSize(200,200);
            HBox halfRem= new HBox();
            halfRem.getChildren().addAll(remMember,remBook,remJournal);
            ...
            remJournal.setOnAction(event1 -> {
                Registration reg= Registration.getInstance();
                reg.remJournals(ID,password);
            });
        ...
        sc.getStylesheets().add("application//style.css");
