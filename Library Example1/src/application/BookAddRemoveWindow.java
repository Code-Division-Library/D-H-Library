...
public class BookAddRemoveWindow {

    static private VBox centerVBox;
    static Connection myCon;
    static TableView<Book> table;
    static ConnectionClass conn;
    static private TableColumn<Book, String> title;
    static private TableColumn<Book, String> author;
    static private TableColumn<Book, String> actedBy;
    static private TableColumn<Book, Date> date;
    static private TableColumn<Book, String> time;
    static private TableColumn<Book, String> action;
    static private TableColumn<Book, Integer> actedByID;
    static private TableColumn<Book, String> actedByName;
    static private TableColumn<Book, Integer> copies;
    ...
    static{
        ...
        author = new TableColumn<>("Author/Volume");
